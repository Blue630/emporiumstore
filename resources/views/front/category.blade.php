...
{
?>
<li><a href="{{url('subcategory/'.$allsubcategory->slug)}}" class="ft-bold active">{{$allsubcategory->name}}</a></li>
<!-- <li><a href="#" class="ft-bold active">{{$allsubcategory->name}}</a></li> -->
<?php
}
}
?>
...
<div class="image">
<a href="{{url('product-detail/'.$category_product_result->slug)}}"><img src="{{ asset('public/products/'.$category_product_result->image) }}" class="img-fluid" alt=""></a>
</div>
...
<div class="p_name">
<a href="{{url('product-detail/'.$category_product_result->slug)}}">{{$category_product_result->name}}</a>
</div>
...
<div class="p_price">
<i class="fas fa-pound-sign"></i> {{$category_product_result->price}}
</div>
<?php
