...
<div class="image">
<a href="{{url('product-detail/'.$justlaunchedproducts_result->slug)}}"><img src="{{ asset('public/products/'.$justlaunchedproducts_result->image) }}" class="img-fluid" alt=""></a>
</div>
...
<button title="Add to Wish List" data-toggle="tooltip" type="button" class="btn-wishlist" href="javascript:void(0);" onClick="addwishlist('<?php echo $justlaunchedproducts_result->id; ?>');">
    <?php
...
<div class="p_name">
<a href="{{url('product-detail/'.$justlaunchedproducts_result->slug)}}">{{$justlaunchedproducts_result->name}}</a>
</div>
