                            ...
                            <div class="accordion-item  border-0 OperatingSystem_filter checkbox_filter">
                                <h2 class="accordion-header" id="heading<?php echo $a; ?>">
                                    <button class="accordion-button collapsed ft-20 lh-30 ft-500" type="button"
                                        ...
                                        aria-expanded="false" aria-controls="collapse<?php echo $a; ?>">
                                ...
                                <div id="collapse<?php echo $a; ?>"
                                    class="accordion-collapse collapse ps-4 text-secondary"
                                    aria-labelledby="heading<?php echo $a; ?>">
                                            ...
                                            <div class="checkbox">
                                                <label for="{{ $option_name }}">
                                                    <input type="checkbox" <?php echo $checked; ?>
                                                        onchange="javascript:document.getElementById('sortbyfrm').submit();"
                                                        id="{{ $option_name }}" name="{{ $allspecifications->name }}[]"
                                                        value="{{ $option_name }}">
...
?>
        ...
        <div class="col-lg-9 ps-lg-5">
                            ...
                            <div class="border radius-5">
                                <div class="d-flex sortby_filter_listing">
                                    ...
                                    <div class="newset_filter">
                                        <select style="border:none;" class="newset_filter" name="sortbyorder"
                                            id="sortbyorder"
                                            onchange="javascript:document.getElementById('filterbyfrm').submit();">
                                            <!--<option value="">Sort By Order</option>-->
                                            <option value="asc" <?php if (isset($_REQUEST['sortbyorder']) && $_REQUEST['sortbyorder'] == 'asc') {
                                                echo 'SELECTED';
                                            } ?>>Oldest</option>
                                            <option value="desc" <?php if (isset($_REQUEST['sortbyorder']) && $_REQUEST['sortbyorder'] == 'desc') {
                                                echo 'SELECTED';
                                            } ?>>Newest</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="price_sorting">
                                        <select style="border:none;" name="sortby" id="sortby"
                                            onchange="javascript:document.getElementById('filterbyfrm').submit();">
                                            <!--<option value="">Sort By Price</option>-->
                                            <option value="lowtohigh" <?php if (isset($_REQUEST['sortby']) && $_REQUEST['sortby'] == 'lowtohigh') {
                                                echo 'SELECTED';
                                            } ?>>Low To High</option>
                                            <option value="hightolow" <?php if (isset($_REQUEST['sortby']) && $_REQUEST['sortby'] == 'hightolow') {
                                                echo 'SELECTED';
                                            } ?>>High To Low</option>
                                        </select>
                                    </div>
            ...
            <div class="product_grid product_wrapper">
                <div class="row">
                    <?php
                        $justlaunchedproductscount = count($justlaunchedproducts);
                        if($justlaunchedproductscount>0)
                        {
                        foreach ($justlaunchedproducts as $justlaunchedproducts_result) 
                        {
                        $product_id = $justlaunchedproducts_result->id;
                    ?>
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="products_unit">
                            <div class="image">
                                <a href="{{ url('product-detail/' . $justlaunchedproducts_result->slug) }}"><img
                                        src="{{ asset('public/products/' . $justlaunchedproducts_result->image) }}"
                            ...
                            <div class="products_desc">
                                <div class="p_wishlist">
                                    ...
                                    <button title="Add to Wish List" data-toggle="tooltip" type="button"
                                        class="btn-wishlist" href="javascript:void(0);"
                                        onClick="addwishlist('<?php echo $justlaunchedproducts_result->id; ?>');">
                                        <?php
                                            $wishlist = DB::table('wishlist')->where(array('user_id'=>$user_id,'status'=>1,'product_id'=>$justlaunchedproducts_result->id))->get();
                                    ...
                                    <button title="Wish List" data-toggle="tooltip" type="button"
                                        class="btn-wishlist" href="javascript:void(0);" onClick="wishlist();"><i
                                ...
                                <div class="p_name">
                                    <a
                                        href="{{ url('product-detail/' . $justlaunchedproducts_result->slug) }}">{{ $justlaunchedproducts_result->name }}</a>
                                </div>
                                <div class="p_rating d-flex align-items-center gap-2">
                                    @php
                                        $rating_data = Review::getRatingAverage($justlaunchedproducts_result->id);
                                    @endphp
                                ...
                                <div class="p_price">
                                    <i class="fas fa-pound-sign"></i> {{ $justlaunchedproducts_result->price }}
                                </div>
                                <?php
