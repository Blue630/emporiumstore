        ...
        <div class="col-xl-6 col-md-8 mx-auto">
            <div class="shadow p-4 p-lg-5">
                ...
                <div class="p-4 p-lg-5" id=" ">
                    <div id="seller-Login">
                        <form id="checkotpform" method="post" action="{{url('/send-create-new-password')}}">
                        @csrf
                            <div class="mb-4 pb-3">
...
$('#sendotp').click(function() {
    ...
    $.ajax({
    url:'{{ url('/front/forgetpassword-sendotp') }}',
    method:'post',
    data:{'email':email,verify_pto:verify_pto, _token:'{{csrf_token()}}'},
