...
//$order_seller_id;
$sellerids = array();
$getorderdeatil = DB::table('order_detail')->where('order_id',$myorderid)->get();
foreach ($getorderdeatil as $order_value)
{
	...
	$getorder = DB::table('orders')->where(array('id'=>$myorderid))->first();
	$oid = $getorder->oid;
...
?>
	...
	<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	    <td width="50%" align="center" valign="top"><img src="https://emporiumstore.co.uk/public/front/img/LOGO-seller.jpg" width="140" /></td>
	  ...
	  <tr>
	    ...
	    *   
	    ...
	    {{$buyer_country}}  <br />
	    <!--<strong>State/UT Code</strong>: 07-->
	    </td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td valign="top"><strong>Order Number:</strong> {{$oid}}-{{$myorderid}}<br />
	...
	<table class="table" width="100%" border="1" cellspacing="0" cellpadding="1" style="border:1px solid #414141;">
	  <tr>
	    ...
	    <td width="6%" bgcolor="#cacaca"><strong>VAT</strong></td>
		...
		<?php
		$srl = 0;
		$get_order_deatil = DB::table('order_detail')->where(array('order_id'=>$myorderid,'seller_id'=>$seller_id))->get();
	  ...
	  <tr>
	    ...
	    <td>&nbsp;</td>
	    <?php
		$purchases = DB::table('order_detail')->where(array('order_id'=>$myorderid,'seller_id'=>$seller_id))->sum('product_amount');
	...
	<p>&nbsp;</p>
	<button style="margin-left:auto;margin-right: auto;display: block;" onclick="window.print()">Print this page</button><br>
	    </td>
	  </tr>
	</table>
	</body>
