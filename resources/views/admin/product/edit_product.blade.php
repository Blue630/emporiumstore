...
$product_detail = DB::table('products')->where('id',$product_ids)->orderBy('id','desc')->first();
$seller_id = $product_detail->user_id;
?>
...
$(document).ready(function(){
    ...
    $('#catid').on('change',function(){
        ...
        //alert(catId);
        $.ajax({
                url:'{{ url('admin/getspecification') }}',
                method:'get',
                type:'html',
                data:{catId:catId},
                success:function(data){
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-body">
            ...
            @endif
            <form method="post" action="{{url('admin/editproduct')}}/{{$productdetail->id}}" enctype="multipart/form-data" onsubmit="onSubmit()">
              @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0.1" step="0.1" value="@if($productdetail){{$productdetail->price}}@endif" id="price" name="price" class="form-control" placeholder="Price">
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <hr>
                        <div class="dlete_row"><a href="#" onclick="if(confirm('Are you sure want to delete?')){ document.location.href='{{url('/admin/deletevariant')}}/<?php echo $variant_id;?>/<?php echo $product_id; ?>'} else{return false;}">x</a></div>
                        <?php
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group img_sets">
                                <div class="input-group mb-3 d-flex">                                    
                                    ...
                                    <a href="#" onclick="if(confirm('Are you sure want to delete?')){ document.location.href='{{url('/admin/deleteadditional')}}/<?php echo $imagevalue->id;?>/<?php echo $product_id; ?>'} else{return false;}">X</a>
                                     </div>
                                    <?php
                                    }
                                    }
