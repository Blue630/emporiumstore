...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
                ...
                <div class="row">
                <div class="col-sm-12">
                <ol class="breadcrumb float-sm-left" style="background-color: transparent;">
                <a style="width:230px;" href="{{url('/Import-product-sample-file.csv')}}" class="btn btn-primary"><i class="fa fa-download">&nbsp;</i> Download Prouct Sample</a>
                </ol>
                <ol class="breadcrumb float-sm-left" style="background-color: transparent;">
