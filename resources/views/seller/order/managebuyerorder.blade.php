...
<div class="content-wrapper">
    ...
    @endif
                ...
                <div class="card-body">
                    <div class="alert alert-success"><b>Manage Buyer Orders</b></div>
                    <table id="example2" class="table table-bordered table-striped">
                        ...
                        @endphp
                           @if($buyerorder)
                                @foreach($buyerorder as $allorder)
                                <tr>
                                <td>{{$srn}}</td>
                                ...
                                <td>
                                 <a href="{{url('/admin/manageorder/details')}}/{{$allorder->orderid}}">View Details</a> 
