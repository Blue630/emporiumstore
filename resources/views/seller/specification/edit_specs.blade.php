      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            @endif
            <form method="post" action="{{url('admin/edit_specs')}}/{{@$specsdetail->id}}" enctype="multipart/form-data">
              @csrf
            <div class="row">
...
<option @php echo ($category->id == $specsdetail->cat_id ?'selected="selected"':"") @endphp  value="{{$category->id}}">{{$category->catname}}</option>
@php
}
@endphp
