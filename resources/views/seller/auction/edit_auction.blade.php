        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/seller/manageauction')}}" class="btn btn-primary"><i class="fas fa-backward"></i>&nbsp;</i>Back</a></li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-body">
            ...
            @endif
            <form method="post" action="{{url('seller/editauction')}}/{{$auctiondetail->id}}" enctype="multipart/form-data" onsubmit="onSubmit()">
              @csrf
