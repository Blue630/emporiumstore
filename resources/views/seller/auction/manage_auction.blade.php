...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <a href="{{url('/seller/addauction')}}" class="btn btn-block btn-primary">Add Auction</a>
        </ol>
    </div>
    <!-- /.col -->
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
                <div class="card-body">
                <form name="sortbyfrm" id="sortbyfrm" method="get" action="{{url('seller/manageauction')}}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {
                                    ?>
                                    <a href="{{url('/seller/inactiveauction')}}/{{$allauction->id}}">Active</a>
                                    <?php
                                    }
                                    else
                                    {
                                    ?>
                                    <a href="{{url('/seller/activeauction')}}/{{$allauction->id}}">InActive</a>
                                    <?php
                                    }
                                    ?>
                                </td>
                                ...
                                <td>
                                    <a href="{{url('/seller/editauction')}}/{{$allauction->id}}">Edit</a>

                                </td>
                                <td>
                                    <a href="{{url('seller/bids')}}/{{$allauction->id}}"<i class="fas fa-arrow-circle-right" style="font-size: 24px;"></i></a>
                                </td>
                            </tr>
                            @php $srn++ @endphp
                            @endforeach
