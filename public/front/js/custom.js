...
/* aside nav */
 ...
 $('.menu_group>a').click(function(e) {
                e.preventDefault();
                $(this).siblings('ul').slideToggle();
                $(this).toggleClass('activated');
            });
            $('.showAllmenuGroup').click(function() {
                $(this).parent().find('.hideGroupAll').slideToggle();
                $(this).toggleClass('activated');
            });

            $('.hitasidemenu').click(function() {
                $('body').toggleClass('aisdemenuToggle');
                $('#main-header~*').toggleClass('blurred');
            });
            ...
            function mainatinAsideNav() {
                var getHeightHeader = $('#main-header').height();
                var getTotalHeight = $('HTML').height();
                var Calcheight = getTotalHeight - getHeightHeader;
                $('#asideMenumain').css('min-height', Calcheight);
...
/* aside nav end */
    ...
    $('.aside_toggle').click(function() {
        ...
        $('#product_aside_bar').next().addClass('blurredd');
    });
    $('.close_aside_toggle').click(function() {
        $('#product_aside_bar').removeClass('active');
        $('#product_aside_bar').next().removeClass('blurredd');
    });
    ...
    $(".toggle-password").on('click', function() {
        ...
        var saveattr = $('#password').attr('type');
