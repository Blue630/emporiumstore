...
<a href="#" class="ft-18 lh-27"><i data-feather="chevron-left"></i> <?php echo e($category_name); ?></a>
...
{
?>
<li><a href="<?php echo e(url('subcategory/'.$allsubcategory->slug)); ?>" class="ft-bold active"><?php echo e($allsubcategory->name); ?></a></li>
<!-- <li><a href="#" class="ft-bold active"><?php echo e($allsubcategory->name); ?></a></li> -->
<?php
}
}
?>
...
<?php echo e($allspecifications->name); ?>
...
?>
<div class="checkbox">
<label for="<?php echo e($option_name); ?>">
    <input type="checkbox" <?php echo $checked;?> onchange="javascript:document.getElementById('sortbyfrm').submit();" id="<?php echo e($option_name); ?>" name="<?php echo e($allspecifications->name); ?>[]" value="<?php echo e($option_name); ?>">
    <span><?php echo e($option_name); ?></span>
</label>
</div>
<?php
}
...
<?php
$categoryproductcount = count($categoryproduct);
if($categoryproductcount>0)
{
foreach($categoryproduct as $category_product_result)
{
$product_id = $category_product_result->id;
/*$seller_id = $category_product_result->user_id;
...
<div class="image">
<a href="<?php echo e(url('product-detail/'.$category_product_result->slug)); ?>"><img src="<?php echo e(asset('public/products/'.$category_product_result->image)); ?>" class="img-fluid" alt=""></a>
</div>
...
<button title="Add to Wish List" data-toggle="tooltip" type="button" class="btn-wishlist" href="javascript:void(0);" onClick="addwishlist('<?php echo $category_product_result->id; ?>');">
    <?php
    $wishlist = DB::table('wishlist')->where(array('user_id'=>$user_id,'status'=>1,'product_id'=>$category_product_result->id))->get();
...
<div class="p_name">
<a href="<?php echo e(url('product-detail/'.$category_product_result->slug)); ?>"><?php echo e($category_product_result->name); ?></a>
</div>
<div class="p_rating d-flex align-items-center gap-2">
<?php
$rating_data = Review::getRatingAverage($category_product_result->id);
?>
<div class="ratingofprod">
<div class="ratinga2">
    <div class="ratinga" data-value="<?php echo e($rating_data['rating']); ?>"></div>
</div>
</div> 
<span>(<?php echo e($rating_data['reviews']); ?>)</span>
</div>

<div class="p_price">
<i class="fas fa-pound-sign"></i> <?php echo e($category_product_result->price); ?>
...
?>
<div class="p_offer">
<?php echo e($cashbackpercent); ?>% Cashback
</div>
<?php
}
?>
...
<?php echo $categoryproduct->links(); ?>
...
<?php echo $__env->yieldContent('footer'); ?><?php /**PATH D:\Works\Work-2022\laravel\resources\views//front/category.blade.php ENDPATH**/ ?>