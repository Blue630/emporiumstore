        ...
        <div class="col-xl-6 col-md-8 mx-auto">
            <div class="shadow p-4 p-lg-5">
                ...
                <div class="p-4 p-lg-5" id=" ">
                    <div id="seller-Login">
                        <form id="checkotpform" method="post" action="<?php echo e(url('otpverification')); ?>">
                        <?php echo csrf_field(); ?>
                            <div class="mb-4 pb-3">
...
</script><?php /**PATH D:\Works\Work-2022\laravel\resources\views/front/enter-otp.blade.php ENDPATH**/ ?>