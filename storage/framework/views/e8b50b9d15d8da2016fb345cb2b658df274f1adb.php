...
<div class="container px-5 rat">
    <section id="home_slideshow">
        <div id="owl_slideshow" class="owl-carousel owl-theme big_arrow">
            ...
            ?>
            <div class="item">
                <a href="<?php echo e($slider_result->url); ?>"><img style="width:100%;" src="<?php echo e(asset('public/slider/'.$slider_result->image)); ?>" alt=""></a>
            </div>
            <?php
            }
            }
...
<div class="container">
    <section id="featured_prod" class="slider_sec">
        <div class="row align-items-center">
            ...
            <div class="col-lg-9">
                <div class="owl-carousel boxed_arrow" id="stagepadding1">
                    ...
                    ?>
                    <div class="item">
                        <a href="<?php echo e(url('product-detail/'.$featuredproduct_result->slug)); ?>">
                            <img style="width:240px;height:240px;" src="<?php echo e(asset('public/products/'.$featuredproduct_result->image)); ?>" class="shadow"
                                alt="<?php echo e($featuredproduct_result->name); ?>" />
                        </a>
                    </div>
                    <?php
                    }
        ...
        <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('/featured-products')); ?>" class="ft-18 text-white">VIEW ALL</a></div>
    </section>
</div>
<?php
}
...
<div class="container">
    <section id="category-list">
        ...
        <div id="category_list" class="owl-carousel owl-theme big_arrow arrow_padding">
            ...
            ?>
            <div class="item">
                <a href="<?php echo e(url('category/'.$allcategory->slug)); ?>"><img style="width:174px;height:174px;"
                        src="<?php echo e(asset('public/category/'.$allcategory->categoryimg)); ?>" class="rounded-circle shadow"
                        alt="" />
    ...
    <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('categories/')); ?>" class="ft-18 pr-30 text-black">VIEW ALL</a></div>
</div>
<?php
...
<div class="container mt-5 pt-4">
    <section id="todays-deal" class="slider_sec shadow-set px-30 py-20 pb-4">
        <div class="row align-items-center">
            ...
            <div class="col-lg-9">
                <div class="owl-carousel boxed_arrow boxed_arrow_black" id="todaysDeal">
                    ...
                    ?>
                    <div class="item">
                        <a href="<?php echo e(url('product-detail/'.$todaydealproductsresult->slug)); ?>"><img style="width:240px;height:240px;" src="<?php echo e(asset('public/products/'.$todaydealproductsresult->image)); ?>" class="shadow"
                                alt="<?php echo e($todaydealproductsresult->name); ?>" /></a>
                    </div>
                    <?php
                    }
                    ?>
        ...
        <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('today-deal/')); ?>" class="ft-18 text-black">VIEW ALL</a></div>
    </section>
</div>
<?php
}
...
<div class="container mt-5 pt-4">
    <section id="best-seller">
        ...
        <div id="bestseller" class="owl-carousel owl-theme big_arrow arrow_padding">
            ...
            ?>
            <div class="item">
                <a href="<?php echo e(url('best-seller-product/'.$seller_result1->u_id)); ?>">
                    <?php
                    if($image!='')
                    {
                    ?>
                    <img src="<?php echo e(asset('/public/front')); ?>/img/<?php echo e($seller_result->image); ?>" class="rounded-circle shadow"
                        alt="<?php echo e($seller_name); ?>" title="<?php echo e($storename); ?>">
                        <?php
                    }
                    elseif($image=='seller.png'){
                        ?>
                        <img src="<?php echo e(asset('/public/front')); ?>/img/user.png" class="rounded-circle shadow"
                        alt="<?php echo e($seller_name); ?>" title="<?php echo e($storename); ?>">
                        <?php
                    }
                        ?>
    ...
    <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('best-sellers/')); ?>" class="ft-18 pr-30 text-black">VIEW ALL</a></div>
</div>
<?php
...
<div class="container mt-5 pt-4">
    <section id="top-rated" class="slider_sec shadow-set px-30 py-20 pb-4">
        <div class="row align-items-center">
            ...
            <div class="col-lg-10">
                <div class="owl-carousel boxed_arrow boxed_arrow_black" id="toprated">
                    ...
                    ?>
                    <div class="item">
                        <a href="<?php echo e(url('product-detail/'.$topproduct_result->slug)); ?>">
                            <p><?php echo e($topproduct_result->name); ?></p>
                            <img style="width:226px;height:197px;" src="<?php echo e(asset('public/products/'.$topproduct_result->image)); ?>" class="shadow" alt="<?php echo e($topproduct_result->name); ?>" />
                        </a>
                    </div>
                    <?php
                    }
        ...
        {
        ?>
        <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('top-rated/')); ?>" class="ft-18 text-black">VIEW ALL</a></div>
        <?php
        }
        ?>
    </section>
...
<div class="container mt-5 pt-4">
    <section id="just-launched">
        ...
        <div id="justlaunched" class="owl-carousel owl-theme big_arrow arrow_padding">
            ...
            ?>
            <div class="item">
            <a href="<?php echo e(url('product-detail/')); ?>/<?php echo e($newproduct->slug); ?>"><img src="<?php echo e(asset('/public/products')); ?>/<?php echo e($newproduct->image); ?>" class="rounded-circle shadow new-launched-home" alt="" style="height:170px;object-fit:contain" /></a>
            </div>
            <?php
            }
            }
    ...
    <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('just-launched/')); ?>" class="ft-18 pr-30 text-black">VIEW ALL</a></div>
</div>
<?php
...
<div class="container my-5 pt-5">
    <section id="weekly-deals" class="slider_sec shadow-set px-30 py-20 pb-4">
        <div class="row align-items-center">
            ...
            <div class="col-lg-9">
                <div class="owl-carousel boxed_arrow boxed_arrow_black" id="weeklydeals">
                    ...
                    ?>
                    <div class="item">
                        <a href="<?php echo e(url('product-detail/'.$weeklydealsproduct_result->slug)); ?>"><img style="width:240px;height:240px;" src="<?php echo e(asset('public/products/'.$weeklydealsproduct_result->image)); ?>" class="shadow"
                                alt="<?php echo e($weeklydealsproduct_result->name); ?>" /></a>
                    </div>
                    <?php
                    }
                    ?>
        ...
        <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('weekly-deals/')); ?>" class="ft-18 text-black">VIEW ALL</a></div>
    </section>
</div>
<?php
}
...
<div class="container mt-5 pt-4">
    <section id="early-sale">
        ...
        <div id="earlysale" class="owl-carousel owl-theme big_arrow arrow_padding">
            ...
            ?>
            <div class="item">
                <a href="<?php echo e(url('product-detail/'.$season_product_result->slug)); ?>">
                    <img style="width:174px;height:174px;" src="<?php echo e(asset('public/products/'.$season_product_result->image)); ?>" class="rounded-circle shadow"
                        alt="<?php echo e($season_product_result->name); ?>" />
                </a>
            </div>
            <?php
            }
    ...
    <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('seasonal-products/')); ?>" class="ft-18 pr-30 text-black">VIEW ALL</a></div>
</div>
<?php
}
?>
                            ...
                            <div class="item">
                                <div class="row pt-4">
                                    <div class="col-md-3 text-center">
                                       <img src="<?php echo e(asset('/public/products')); ?>/<?php echo e($unrated_product->image); ?>" class="img-fluid mb-4" alt="">
                                    </div>
                                    <div class="col-md-9 px-4">
                                        <form method="post" action="<?php echo e(url('/rate-unrated-product/')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <h3 class="ft-25 text-black text-center"><?php echo e($unrated_product->name); ?></h3>
                                        ...
                                        for($i=0;$i<5;$i++){
                                        ?>
                                        <div class="star<?php echo e($i); ?>">
                                        <label for="<?php echo e($i); ?>star">
                                            <input type="radio" id="<?php echo e($i); ?>star" name="starrating[<?php echo e($i); ?>]">
                                            <span class="show_star"></span></label>
                                        <p class="ft-13 ft-light">
                                        
                                        <?php echo e($ratearr[$i]); ?></p>
                                        <input type="hidden" name="unrated_product_id" value="<?php echo e($unrated_product->product_id); ?>">
                                        <input type="hidden" name="unrated_user_id" value="<?php echo e($user_id); ?>">
                                        <input type="hidden" name="unrated_orderdetail_id" value="<?php echo e($unrated_product->order_detail_id); ?>">                                  </div>
                                        <?php 
                                        }
                                        ?>
                                        </div>
...
<div class="container my-5 pt-5">
    <section id="month-deals" class="slider_sec shadow-set px-30 py-20 pb-4">
        <div class="row align-items-center">
            ...
            <div class="col-lg-9">
                <div class="owl-carousel boxed_arrow boxed_arrow_black" id="monthdeals">
                    ...
                    ?>
                    <div class="item">
                        <a href="<?php echo e(url('product-detail/'.$monthlydealsproduct_result->slug)); ?>"><img src="<?php echo e(asset('public/products/'.$monthlydealsproduct_result->image)); ?>" class="shadow"
                                alt="<?php echo e($monthlydealsproduct_result->name); ?>" /></a>
                    </div>
                    <?php
                    }
                    ?>
        ...
        <div class="text-end pt-4 pe-5"><a href="<?php echo e(url('/deal-of-the-month')); ?>" class="ft-18 text-black">VIEW ALL</a></div>
    </section>
</div>
<?php
}
        ...
        <div id="toppicks" class="owl-carousel owl-theme big_arrow arrow_padding">
            ...
            <div class="item">
                <a href="<?php echo e(url('product-detail/'.$product->slug)); ?>">
                    <img style="width:174px;height:174px;" src="<?php echo e(asset('public/products/'.$product->image)); ?>" class="rounded-circle shadow" alt=""
                         />
                </a>
            </div>
            <?php
...
<section id="signup_newsletter" class="my-5 py-5 px-5">
    ...
    <div class="d-lg-flex align-items-center justify-content-center">
    <?php if($msg=Session::get('success')): ?><span style="color:green"><?php echo e($msg); ?></span><?php endif; ?></div>
</section>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form class="login" method="post" action="<?php echo e(url('newsletter')); ?>">
        <?php echo csrf_field(); ?>
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" class="form-control" id="email" value="<?php echo e($email); ?>" placeholder="Email Id" name="email" required>
      </div>
...
<?php echo $__env->yieldContent('footer'); ?><?php /**PATH D:\Works\Work-2022\laravel\resources\views/front/index.blade.php ENDPATH**/ ?>