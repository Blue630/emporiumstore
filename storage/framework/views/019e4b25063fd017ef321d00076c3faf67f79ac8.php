...
<form class="login" method="post" action="<?php echo e(url('dologin')); ?>">
<?php echo csrf_field(); ?>
<div class="mb-4 pb-3">
    <?php
...
<div class="mb-3 mt-5">
    <a href="<?php echo e(url('/forget-password-email')); ?>" class="form-check-label text-secondary">Forgot your Password?</a>
</div>
...
<?php echo csrf_field(); ?>
<h3 class="ft-25 lh-36 ft-400 text-center mb-5">We want to know more about you?<br><?php if($msg=Session::get('success')): ?><span style="color:red"><?php echo e($msg); ?></span><?php endif; ?></h3>
<?php
if($errors->first('email')!="")
{
?>
...
<input type="checkbox" name="terms" id="terms" required>  I Agree <a href="<?php echo e(url('terms/')); ?>" target="_blank">Terms & Coditions</a>
<br><br>
...
<?php echo $__env->yieldContent('footer'); ?><?php /**PATH D:\Works\Work-2022\laravel\resources\views//front/login.blade.php ENDPATH**/ ?>